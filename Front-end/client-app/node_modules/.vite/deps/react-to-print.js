    ...
    !function(e, t) {
      ...
      return function() {
        ...
        function h(e2, t2, o2, n2) {
          var r2, s2, l2, d2, h2;
          const { contentNode: f2, clonedContentNode: g2, clonedImgNodes: m, clonedVideoNodes: b, numResourcesToLoad: y, originalCanvasNodes: v } = o2, { bodyClass: w, fonts: E, ignoreGlobalStyles: A, pageStyle: T, nonce: k, suppressErrors: x, copyShadowRoots: S } = n2;
          e2.onload = null;
          const P = null !== (r2 = e2.contentDocument) && void 0 !== r2 ? r2 : null === (s2 = e2.contentWindow) || void 0 === s2 ? void 0 : s2.document;
          if (P) {
            const o3 = P.body.appendChild(g2);
            S && u(f2, o3, !!x), E && ((null === (l2 = e2.contentDocument) || void 0 === l2 ? void 0 : l2.fonts) && (null === (d2 = e2.contentWindow) || void 0 === d2 ? void 0 : d2.FontFace) ? E.forEach((o4) => {
              ...
              t2(e3);
            }), i({ messages: ['"react-to-print" is not able to load custom fonts because the browser does not support the FontFace API but will continue attempting to print the page'], suppressErrors: x })));
            const n3 = null != T ? T : p, r3 = P.createElement("style");
            k && (r3.setAttribute("nonce", k), P.head.setAttribute("nonce", k)), r3.appendChild(P.createTextNode(n3)), P.head.appendChild(r3), w && P.body.classList.add(...w.split(" "));
            const s3 = P.querySelectorAll("canvas");
            for (let e3 = 0; e3 < v.length; ++e3) {
              const t3 = v[e3], o4 = s3[e3];
              if (void 0 === o4) {
                i({ messages: ["A canvas element could not be copied for printing, has it loaded? `onBeforePrint` likely resolved too early.", t3], suppressErrors: x });
                continue;
              }
            ...
            const c2 = "select", y2 = f2.querySelectorAll(c2), N = P.querySelectorAll(c2);
            for (let e3 = 0; e3 < y2.length; e3++) N[e3].value = y2[e3].value;
            if (!A) {
              ...
              for (let o4 = 0, n4 = e3.length; o4 < n4; ++o4) {
                ...
                if ("style" === n5.tagName.toLowerCase()) {
                  const e4 = P.createElement(n5.tagName), t3 = n5.sheet;
                  if (t3) {
                    let r4 = "";
                    try {
...
`);
                    ...
                    e4.setAttribute("id", `react-to-print-${o4}`), k && e4.setAttribute("nonce", k), e4.appendChild(P.createTextNode(r4)), P.head.appendChild(e4);
                  }
                  ...
                  const e4 = P.createElement(n5.tagName);
                  ...
                  }, k && e4.setAttribute("nonce", k), P.head.appendChild(e4);
                }
        ...
        function g(e2) {
          const { contentRef: t2, fonts: o2, ignoreGlobalStyles: n2, onBeforePrint: r2, onPrintError: d2, preserveAfterPrint: u2, suppressErrors: p2 } = e2, h2 = (0, s.useCallback)((s2) => {
            ...
            }, x = { contentNode: h3, clonedContentNode: g2, clonedImgNodes: b, clonedVideoNodes: y, numResourcesToLoad: w, originalCanvasNodes: h3.querySelectorAll("canvas") };
            r2 ? r2().then(() => {
              f(T, k, x, e2);
            }).catch((e3) => {
